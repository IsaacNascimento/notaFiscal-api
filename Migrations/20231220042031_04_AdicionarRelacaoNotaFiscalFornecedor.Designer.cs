...
namespace notaFiscal_api.Migrations
{
    ...
    [Migration("20231220042031_04_AdicionarRelacaoNotaFiscalFornecedor")]
    partial class _04_AdicionarRelacaoNotaFiscalFornecedor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Src.Api.Domain.Models.CarrinhoModels.CarrinhoModel", b =>
                {
                    ...
                    b.Property<string>("ProdutoModelIdProduto")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ProdutoModelIdProduto");
            ...
            modelBuilder.Entity("Src.Api.Domain.Models.CarrinhoModels.CarrinhoModel", b =>
                {
                    ...
                    b.HasOne("Src.Api.Domain.Models.ProdutoModels.ProdutoModel", null)
                        .WithMany("Carrinhos")
                        .HasForeignKey("ProdutoModelIdProduto");
