...
namespace notaFiscal_api.Migrations
{
    ...
    [Migration("20231220042911_05_AdicionarRelacaoProdutoCarrinho")]
    partial class _05_AdicionarRelacaoProdutoCarrinho
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Src.Api.Domain.Models.CarrinhoModels.CarrinhoModel", b =>
                {
                    ...
                    b.HasOne("Src.Api.Domain.Models.ProdutoModels.ProdutoModel", "Produto")
                        .WithMany("Carrinhos")
